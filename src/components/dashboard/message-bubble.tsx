  ...
  if (isUser) {
    return (
      <div className="flex justify-end">
        <div className="max-w-[85%] whitespace-pre-wrap rounded-2xl rounded-br-md bg-secondary px-4 py-2.5 text-[15px] leading-7 text-secondary-foreground">
          {message.content}
        </div>
      </div>
    );
...
export function TypingIndicator() {
  return (
    <div className="flex gap-3">
      ...
      <div className="flex items-center gap-1.5 rounded-2xl rounded-tl-md bg-muted px-4 py-4">
