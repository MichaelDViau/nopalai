        ...
        <DialogHeader>
          ...
          <DialogTitle className="text-xl">
            {reason === "limit"
              ...
              : "Desbloquea NopalAI Plus"}
          </DialogTitle>
          <DialogDescription>
            {reason === "limit"
              ? "Usaste tus 20 mensajes gratuitos de hoy. Mejora a Plus y sigue sin interrupciones."
              : "Lleva tu productividad al siguiente nivel por solo 69 MXN al mes."}
          </DialogDescription>
        </DialogHeader>
