...
export default function TermsPage() {
  return (
    <>
      ...
      <p>
        El plan Gratis incluye 20 mensajes diarios. El plan Plus cuesta 69 MXN
        al mes con uso ilimitado, y el plan Pro cuesta 199 MXN al mes e incluye
        acceso a los modelos de IA premium. Los pagos se procesan con Stripe y
        puedes cancelar en cualquier momento; el acceso continúa hasta el final
        del periodo pagado.
      </p>
