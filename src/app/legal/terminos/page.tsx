...
export default function TermsPage() {
  return (
    <>
      ...
      <p>
        El plan Gratis incluye 20 mensajes diarios. Los planes de pago Plus (69
        MXN al mes) y Pro (199 MXN al mes) incluyen mayores límites y funciones.
        Los pagos se procesan con Stripe y puedes cancelar en cualquier momento;
        el acceso continúa hasta el final del periodo pagado.
      </p>
